.. _ref_ugv_devkit_vision_extension_v1.1:
...
+==========+===================+=============+========================+
| 1        | 10/08/2024        | WR Dev Team | Initial release        |
+----------+-------------------+-------------+------------------------+
...
.. note::
    More information on the D435i Depth camera can be found `here <https://github.com/IntelRealSense/realsense-ros?tab=readme-ov-file#ros2robot-vs-opticalcamera-coordination-systems>`_
