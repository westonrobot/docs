...
<ProductCard to="/peripheral/power/power_regulator_v2" title="Power Regulator v2.X">Switchable, regulated output rails for powering payloads from the robot's battery.</ProductCard>
