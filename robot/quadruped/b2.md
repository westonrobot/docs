...
For exact pin assignments, voltage and current ratings for the User Interface Module's USB, 24V power and 12V network connectors, see Unitree's [official B2 documentation](https://support.unitree.com/home/en/B2_developer) — those specs come from Unitree and are best read from the source they maintain, not a copy here.
