...
This page covers the standard, legged A2 — the variant we supply and have verified against a physical unit. The wheel-leg **A2-W** is a physically distinct product (16 DOF vs 12, different mass and dimensions) and cannot be field-converted to or from the legged A2. Most of the SDK and network information below still applies to A2-W, but check any dimension, mass or joint figure against Unitree's own documentation for the variant you have — they differ.
...
We supply the standard, legged A2 — not A2-W, A2-Pro or A2-W-Pro. For dimensions, mass, joint limits and ratings, use Unitree's documentation linked at the top of this page: those figures are theirs and they revise them.
