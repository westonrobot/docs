.. _ref_onboard_industrial_5g_wifi_router:
...
+==========+===================+=============+==================================+
| 1        | 16/05/2024        | Ruixiang Du | Initial release                  |
+----------+-------------------+-------------+----------------------------------+
| 2        | 17/05/2024        | Hans Kurnia | Add common configuration section |
+----------+-------------------+-------------+----------------------------------+
...
.. image:: /periph_user_guide/westonrobot/figures/5g_router/home_page.png
    :width: 450 px
    :align: center

2. Click into the AP client configuration page.

.. image:: /periph_user_guide/westonrobot/figures/5g_router/ap_client_tab.png
    :width: 450 px
    :align: center
...
.. image:: /periph_user_guide/westonrobot/figures/5g_router/operation_mode.png
    :width: 450 px
    :align: center
...
.. image:: /periph_user_guide/westonrobot/figures/5g_router/5ghz_setting.png
    :width: 450 px
    :align: center
...
.. image:: /periph_user_guide/westonrobot/figures/5g_router/lan_config_tab.png
    :width: 450 px
    :align: center

1. Adjust the LAN settings as needed and click "Apply".
    
    **Note**: DHCP server settings should be adjusted automatically to suit the new LAN settings.

.. image:: /periph_user_guide/westonrobot/figures/5g_router/lan_settings.png
    :width: 450 px
    :align: center