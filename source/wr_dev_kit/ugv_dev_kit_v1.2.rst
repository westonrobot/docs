...
+==========+===================+=============+========================+
| 1        | 10/03/2025        | WR Dev Team | Initial release        |
+----------+-------------------+-------------+------------------------+
| 2        | 10/03/2025        | Andrew Chia | Hardware Configuration |
+----------+-------------------+-------------+------------------------+
...
.. image:: ugv_dev_kit_v1.2/figures/overview2.png
    :width: 650 px
...
.. image:: ugv_dev_kit_v1.2/figures/pwr_reg2.png
    :width: 720 px
...
* :ref:`Component Re-configuration Guide <ref_ugv_devkit_component_reconfiguration_v1.2>`
